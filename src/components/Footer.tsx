        ...
        <div className="grid md:grid-cols-3 gap-8 mb-12">
          ...
          <div className="space-y-6">
            ...
            <p className="text-gray-400 leading-relaxed">
              See the world differently with premium eyewear that combines
              cutting-edge technology with timeless style.
            </p>
            <div className="flex space-x-4">
              <a
                href="https://www.instagram.com/dark.wost?igsh=MXFsZ2d5djM2OGlreg=="
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-400">darkwost70@gmail.com</span>
              </div>
              <div className="flex items-center space-x-3">
                <Phone className="w-5 h-5 text-indigo-400" />
                <span className="text-gray-400">DARK-WOST</span>
              </div>
              <div className="flex items-center space-x-3">
